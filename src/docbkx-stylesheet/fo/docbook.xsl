...
<fo:block id="d0e162" text-align="center"><fo:external-graphic src="url(target/docbkx/pdf/images/cometdLogo.png)" width="540px" height="auto" content-width="scale-to-fit" content-height="scale-to-fit" content-type="content-type:image/png" text-align="center"/></fo:block>
<fo:block text-align="center" font-size="24pt" border-width="10mm">The CometD Reference Book</fo:block>
