...
The CometD 2 JavaScript library is a portable JavaScript implementation with
...
where Dojo users might use `dojo.hitch()`, while jQuery users might prefer an
...
include::javascript_publish.adoc[]
